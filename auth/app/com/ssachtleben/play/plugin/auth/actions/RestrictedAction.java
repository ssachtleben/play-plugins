 ...
 * <p>
 * The {@link Restricts} annotation declares a controller method as restricted and the current logged in user needs to be logged in and own
 * the requested role. Otherwise the request will be forbidden.
 * </p>
 * 
...
public class RestrictedAction extends Action<Simple> {
	...
	/**
	 * The default contructor for {@link RestrictedAction} needs the invoked {@code actionMethod} to access to the {@link Restricts}
	 * annotation.
	 * 
	 * @param actionMethod
	...
	/**
	 * Checks if the current logged in user is allowed to access to the requested path.
	 * 
	 * @param ctx
