...
/**
 * Provides login and logout methods to handle authentication process via this
 * plugin. The {@link #login(String)} and {@link #logout()} methods can directly
 * linked in the routes configuration. But if you need additional code in this
 * routes like jpa transaction, then you can create your own routes and use
 * {@link Auth#login(play.mvc.Http.Context, String)} and
 * {@link Auth#logout(play.mvc.Http.Session)} directly.
 * 
