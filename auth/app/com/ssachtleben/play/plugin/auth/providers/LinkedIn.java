...
public class LinkedIn extends BaseOAuth2Provider<LinkedInAuthUser> {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.ssachtleben.play.plugin.auth.providers.BaseOAuthProvider#defaultScope()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.ssachtleben.play.plugin.auth.providers.BaseOAuthProvider#beforeSignRequest(org.scribe.model.OAuthRequest)
	 */
	@Override
