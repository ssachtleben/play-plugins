...
/**
 * The {@link FacebookAuthUser} contains {@code id}, {@code token} and
 * {@code data} properties. The data {@link JsonNode} contains all fetched
 * information based on 'auth.facebook.fields' property in application.conf
 * <p>
 * The {@link Facebook} provider uses this model and pass it to
 * {@link AuthService}.
 * </p>
 * 
