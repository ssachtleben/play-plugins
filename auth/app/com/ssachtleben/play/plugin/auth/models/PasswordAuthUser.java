...
/**
 * The {@link PasswordAuthUser} provides clear password for
 * {@link PasswordEmailAuthUser} and {@link PasswordUsernameAuthUser} and also
 * the create new passwords and compare hashed and candidates.
 * 
...
public abstract class PasswordAuthUser extends AuthUser {
  ...
  /**
   * Check if password is valid. TODO: This should be somehow handled by
   * application...
   * 
   * @param hashed
   *          The hased password.
