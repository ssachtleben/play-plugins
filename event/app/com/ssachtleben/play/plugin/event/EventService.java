...
/**
 * An EventService provides services for publishing events, register new and unregister existing subscribers. It provides two types of
 * publications and subcriptions: object-based and topic-based.
 * <p/>
 * In the class-based process an event will be delivered to any handler where the event is <em>assignable</em>.
 * <p/>
 * In the topic-based process only subscribers who registered to the topic where the event object is published will be notified.
 * 
...
public interface EventService {
	...
	/**
	 * Publishes an {@code event} synchronously and all registered subscribers will be notified if they subscribed to the {@code event}, one
	 * of its subclasses, or to one of the interfaces it implements. The call is blocked until every listener has processed the {@code event}.
	 * 
	 * @param event
	 ...
	 * blocked until every listener has processed the {@code event}.
	 * 
	 * @param topic
	 ...
	 * listener has processed the {@code event}.
	 * 
	 * @param genericType
	 * @param event
	 */
	 ...
	 * of its subclasses, or to one of the interfaces it implements.
	 * 
	 * @param event
	 *          The event object to publish.
	 */
	 ...
	 * be directly a method which will be registered without checking other methods from the same class.
	 * 
	 * @param object
	 ...
	 * annotated methods, or it could be directly a method which will be registered without checking other methods from the same class.
	 * 
	 * @param topic
	 *          The topic name to subscribe.
	 * @param object
