 ...
 * <p/>
 * Its planed to allow custom implementations of {@link EventService} and serve them here, but its not possible right now. The implemented
 * instance is always {@link EventBus}.
 * 
...
public class Events {
	...
	/**
	 * Returns current {@link EventService} implementation instance which is {@link EventBus}.
	 * 
	...
	/**
	 * Create a new instance of {@link EventBus}. The constructor is private to avoid additional instances except this. A reflection hack will
	 * be used to change the constructor accessibility.
	 * 
