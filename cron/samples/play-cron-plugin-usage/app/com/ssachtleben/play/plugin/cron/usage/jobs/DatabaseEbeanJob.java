...
/**
 * The DatabaseEbeanJob runs every 10 seconds and creates a new ModelEbean instance and save to database. Once a model exists the job will
 * update the date property on every execution.
 * 
