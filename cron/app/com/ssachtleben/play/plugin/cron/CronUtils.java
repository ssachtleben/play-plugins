...
public class CronUtils {
  ...
  /**
   * The findAnnotatedJobs method searches for all classes in the current
  ...
  /**
   * The findByInterface method searches for all classes in the current context
   * which implementing the given interface and returns them as a set.
   * 
   * @param type
   *          The type to set
   * @return Set of jobs
